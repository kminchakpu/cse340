 ...
 * This improves performance and reduces load on your database server.
 *
 ...
 * Common SSL Issue:
 *
 * If you encounter SSL connection errors depending on your operating
 * system, Node.js version, or PostgreSQL server settings, try:
 *
 * ssl: {
...
if (
   ...
   * This helps with debugging by showing all executed queries
   * in the console.
   */
